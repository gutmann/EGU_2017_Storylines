  ...
  \begin{column}{.3333\paperwidth} % if all columns have the same width, it's enough to declare that width once
   ...
   \begin{textblock}{\textwidth \TPHorizModule}(66.667,0)
    \begin{block}{5. Outlook: Production of large ensembles of hydrologic projections}
     ...
     \begin{figure}
      \center\includegraphics[width=0.75\linewidth,height=0.5\linewidth]{figures/anova.png}
      \caption{\textbf{Example} of an ANOVA analysis performed using a combination of existing data from the University of Washington RMJOC dataset and the NCAR BCSD dataset. The total dataset includes 2 RCPs, 31 GCMs, 2 \begin{em}simple\end{em} downscaling methods, 1 hydrologic model (VIC), and 4 hydrologic model parameter sets. Each subplot represents a different analysis metric. Each column is a different watershed (Libby, Dalles, Dworshak) in the Columbia River Basin. Changes are for the period 2070-2100 - 1970-2000.
       \label{fig:anova}}
     \end{figure}
